...
## [14.0.0](https://github.com/lots0logs/terraform-provider-rancher2/compare/v14.0.0...v14.0.0) (2026-03-31)


### Features

* add linode vpc and user data fields ([5131260](https://github.com/lots0logs/terraform-provider-rancher2/commit/51312609de7898665861a640f7a5cc9fa0cde743))
* Add new field `extended` to resource quota handlers ([#1811](https://github.com/lots0logs/terraform-provider-rancher2/issues/1811)) ([3f3da57](https://github.com/lots0logs/terraform-provider-rancher2/commit/3f3da57a5168c6b697b125d4d364774e375a2794))
* add reserved memory field ([#1510](https://github.com/lots0logs/terraform-provider-rancher2/issues/1510)) ([c1b4fa0](https://github.com/lots0logs/terraform-provider-rancher2/commit/c1b4fa0bbb74f2a9be9616419ede917504e8e5e0))
* added ipv6 suppport for eks operator ([#2005](https://github.com/lots0logs/terraform-provider-rancher2/issues/2005)) ([e6f04c7](https://github.com/lots0logs/terraform-provider-rancher2/commit/e6f04c7b0e4182b44f1222ee71c0117c22bcc0fb))
* cluster proxy config ([#1683](https://github.com/lots0logs/terraform-provider-rancher2/issues/1683)) ([e2a374a](https://github.com/lots0logs/terraform-provider-rancher2/commit/e2a374a01ab451ec90c6fd41f646b833309a8185))
* GitHub app provider ([#1695](https://github.com/lots0logs/terraform-provider-rancher2/issues/1695)) ([cf6e584](https://github.com/lots0logs/terraform-provider-rancher2/commit/cf6e5849de63cee6acc859b7bebceb61d345ce15))
* implement PC and PDB support for the fleet agent ([#1986](https://github.com/lots0logs/terraform-provider-rancher2/issues/1986)) ([ebf8d31](https://github.com/lots0logs/terraform-provider-rancher2/commit/ebf8d31fd977a53aa40730f5a8c147f1d5145993))
* implement support to nutanix machine config ([#2083](https://github.com/lots0logs/terraform-provider-rancher2/issues/2083)) ([a214fea](https://github.com/lots0logs/terraform-provider-rancher2/commit/a214fea018afd20222a5ece6058af1b8a30e3a04))
* keycloak OIDC auth provider ([#2033](https://github.com/lots0logs/terraform-provider-rancher2/issues/2033)) ([90d2e4e](https://github.com/lots0logs/terraform-provider-rancher2/commit/90d2e4e1f5afd278ff8730120bae297af8e3de26))


### Bug Fixes

* [Docs] Add inherited_cluster_roles to docs ([#1342](https://github.com/lots0logs/terraform-provider-rancher2/issues/1342)) ([04d1088](https://github.com/lots0logs/terraform-provider-rancher2/commit/04d10888eb9e360f01c45a1dd22a1409516e1207))
* add all protocols to metadata ([#1794](https://github.com/lots0logs/terraform-provider-rancher2/issues/1794)) ([186d8f6](https://github.com/lots0logs/terraform-provider-rancher2/commit/186d8f6643c43911ea7b9ad98bb72fb7e080a5c8))
* add automation for release issues and tests ([#1692](https://github.com/lots0logs/terraform-provider-rancher2/issues/1692)) ([31d75e5](https://github.com/lots0logs/terraform-provider-rancher2/commit/31d75e5180721e1a451c50e7c7e5ae3e3f274ef6))
* add common environment variables to workflow ([#1742](https://github.com/lots0logs/terraform-provider-rancher2/issues/1742)) ([827540e](https://github.com/lots0logs/terraform-provider-rancher2/commit/827540e7e95aafe97cbbd890e714d86acdbf06a1))
* add config for release-please ([#1730](https://github.com/lots0logs/terraform-provider-rancher2/issues/1730)) ([575e79e](https://github.com/lots0logs/terraform-provider-rancher2/commit/575e79e8c9f7ee5b032ba571c8ece6bbb481f265))
* add FOSSA scanning workflow ([#1988](https://github.com/lots0logs/terraform-provider-rancher2/issues/1988)) ([7c865b3](https://github.com/lots0logs/terraform-provider-rancher2/commit/7c865b36803b553f3bb8586e60b90bbd15fb6f2c))
* add manual rc release and update permissions ([#1746](https://github.com/lots0logs/terraform-provider-rancher2/issues/1746)) ([24537b0](https://github.com/lots0logs/terraform-provider-rancher2/commit/24537b0fc7b986716d03d9b8771ad7c897b6e737))
* add permissions to update issues ([#1936](https://github.com/lots0logs/terraform-provider-rancher2/issues/1936)) ([a48759f](https://github.com/lots0logs/terraform-provider-rancher2/commit/a48759f52e5c531d65b7a7ca2828c9d9ce87c504))
* add search option exact match in principal ([#1331](https://github.com/lots0logs/terraform-provider-rancher2/issues/1331)) ([a3f15f1](https://github.com/lots0logs/terraform-provider-rancher2/commit/a3f15f14cca0446676e0d499f119798ccbd686ec))
* add support for AuthConfig Cognito ([#2029](https://github.com/lots0logs/terraform-provider-rancher2/issues/2029)) ([1f3fd79](https://github.com/lots0logs/terraform-provider-rancher2/commit/1f3fd793f7f86c6c96f26170227a143426f5286c))
* add support for data directories ([#1665](https://github.com/lots0logs/terraform-provider-rancher2/issues/1665)) ([637dbb9](https://github.com/lots0logs/terraform-provider-rancher2/commit/637dbb9755af488a279b7e72fb301c54d4bbf83d))
* adjust path and remove module context ([#1706](https://github.com/lots0logs/terraform-provider-rancher2/issues/1706)) ([e2c9c08](https://github.com/lots0logs/terraform-provider-rancher2/commit/e2c9c0822e377c28ee6bcd864bfdb947c9361b17))
* allow specifying sha ([#1764](https://github.com/lots0logs/terraform-provider-rancher2/issues/1764)) ([47e9f55](https://github.com/lots0logs/terraform-provider-rancher2/commit/47e9f5598e6cfb25d6b0e80c745c8a30d2469d43))
* break out the config pkg for better testing ([#1899](https://github.com/lots0logs/terraform-provider-rancher2/issues/1899)) ([80e2197](https://github.com/lots0logs/terraform-provider-rancher2/commit/80e21977be85183cc89fdd86990a5fa8a207d31d))
* build before testing ([#1903](https://github.com/lots0logs/terraform-provider-rancher2/issues/1903)) ([fed4427](https://github.com/lots0logs/terraform-provider-rancher2/commit/fed442767443ca63b01fe5dde75183ed6a8f3526))
* Bump golang.org/x/crypto from 0.33.0 to 0.35.0 ([#1530](https://github.com/lots0logs/terraform-provider-rancher2/issues/1530)) ([e617600](https://github.com/lots0logs/terraform-provider-rancher2/commit/e617600293904004211c5f7f6adb2f3ec1130ee3))
* change from "main" to "tracking" ([#1712](https://github.com/lots0logs/terraform-provider-rancher2/issues/1712)) ([35d9146](https://github.com/lots0logs/terraform-provider-rancher2/commit/35d9146a4ba995654c08bec2e6a4c70686000cc9))
* check out repository ([#1751](https://github.com/lots0logs/terraform-provider-rancher2/issues/1751)) ([cdd8727](https://github.com/lots0logs/terraform-provider-rancher2/commit/cdd8727a4d4994ef75e8f33b531ebae563e9e086))
* clear space on runner before release ([#1848](https://github.com/lots0logs/terraform-provider-rancher2/issues/1848)) ([a5cb46c](https://github.com/lots0logs/terraform-provider-rancher2/commit/a5cb46c3eb83fa790d927f6ee04095b2710a74da))
* clear space on runners before release tests ([#1838](https://github.com/lots0logs/terraform-provider-rancher2/issues/1838)) ([e11d17d](https://github.com/lots0logs/terraform-provider-rancher2/commit/e11d17dfaa85658bf589d815c2ee5a646f3586e0))
* Correct genericoidc provider implementation and tests ([#1691](https://github.com/lots0logs/terraform-provider-rancher2/issues/1691)) ([0d7b485](https://github.com/lots0logs/terraform-provider-rancher2/commit/0d7b485f4f5289a9c7f098e618b685731fd3985d))
* do not check out branch that we tag ([#1932](https://github.com/lots0logs/terraform-provider-rancher2/issues/1932)) ([666f798](https://github.com/lots0logs/terraform-provider-rancher2/commit/666f798b3eab0cddb2dfd0b723a10ed7ced53584))
* do not use dot syntax in path ([#1705](https://github.com/lots0logs/terraform-provider-rancher2/issues/1705)) ([5821942](https://github.com/lots0logs/terraform-provider-rancher2/commit/5821942a237dd6f3c708fa21b3cf773e5b102df9))
* don't check user state on creation ([#1699](https://github.com/lots0logs/terraform-provider-rancher2/issues/1699)) ([4ebecdb](https://github.com/lots0logs/terraform-provider-rancher2/commit/4ebecdb4186a1676616da2fbcdfb29b1cfdca334))
* emit all response data for troubleshooting ([#1714](https://github.com/lots0logs/terraform-provider-rancher2/issues/1714)) ([d8490c3](https://github.com/lots0logs/terraform-provider-rancher2/commit/d8490c314b55ab63d0476a3ec74bc47012dd1bd2))
* enable manual rc release for older branches ([#1834](https://github.com/lots0logs/terraform-provider-rancher2/issues/1834)) ([afc0a9f](https://github.com/lots0logs/terraform-provider-rancher2/commit/afc0a9fd7118f9ba3b7c30c7d0b78817a0d2599b))
* ensure the correct workflow, users, and tags ([#1772](https://github.com/lots0logs/terraform-provider-rancher2/issues/1772)) ([e28d375](https://github.com/lots0logs/terraform-provider-rancher2/commit/e28d375ea4d4f5829cff4825d0844eef4a7e43c8))
* export GitHub scripts and validate in CI ([#1702](https://github.com/lots0logs/terraform-provider-rancher2/issues/1702)) ([4412d64](https://github.com/lots0logs/terraform-provider-rancher2/commit/4412d64f6113bc3a1bcabd9dd4dbd1dcd572ec97))
* fix script paths ([#1704](https://github.com/lots0logs/terraform-provider-rancher2/issues/1704)) ([0609f72](https://github.com/lots0logs/terraform-provider-rancher2/commit/0609f72d82257a82c66f19133f969c6b5163ceba))
* for manual releases skip the git validation ([#1788](https://github.com/lots0logs/terraform-provider-rancher2/issues/1788)) ([d67d532](https://github.com/lots0logs/terraform-provider-rancher2/commit/d67d532439a371b71ee8e505c0bad72430e18cae))
* force directory path ([#1710](https://github.com/lots0logs/terraform-provider-rancher2/issues/1710)) ([305ea61](https://github.com/lots0logs/terraform-provider-rancher2/commit/305ea616c608e710dec5db2fe8c0b22d38e54a38))
* github script uses slashes for comments ([#1863](https://github.com/lots0logs/terraform-provider-rancher2/issues/1863)) ([9a266f9](https://github.com/lots0logs/terraform-provider-rancher2/commit/9a266f9edcec8a18b6a1b0870eedfff1366b8a6b))
* goreleaser needs git state at the new tag ([#1768](https://github.com/lots0logs/terraform-provider-rancher2/issues/1768)) ([2d2805d](https://github.com/lots0logs/terraform-provider-rancher2/commit/2d2805dfa68c48043795f38d1b2616f21cc378aa))
* improve cleanup and skip in CI ([#1895](https://github.com/lots0logs/terraform-provider-rancher2/issues/1895)) ([8f5c657](https://github.com/lots0logs/terraform-provider-rancher2/commit/8f5c657973c1d18f193809a6791e39a06bc2b334))
* improve registry documentation ([#1664](https://github.com/lots0logs/terraform-provider-rancher2/issues/1664)) ([72bbd0c](https://github.com/lots0logs/terraform-provider-rancher2/commit/72bbd0c8ff703749c1ad584abf43d3524ccd10dc))
* improve test isolation logic ([#1879](https://github.com/lots0logs/terraform-provider-rancher2/issues/1879)) ([188dae9](https://github.com/lots0logs/terraform-provider-rancher2/commit/188dae9f0745cbe7609da762f47a1b4e480e6ae7))
* improve the documentation for cluster resources  ([#1805](https://github.com/lots0logs/terraform-provider-rancher2/issues/1805)) ([d2f8ef4](https://github.com/lots0logs/terraform-provider-rancher2/commit/d2f8ef4f65a7ff66eb83ce84020be4b11cdfcab0))
* login ([#2016](https://github.com/lots0logs/terraform-provider-rancher2/issues/2016)) ([edb74ae](https://github.com/lots0logs/terraform-provider-rancher2/commit/edb74ae0b807cbeb91b4da2ea059af8ed25d2d9d))
* make sure to only match the tag specified ([#1776](https://github.com/lots0logs/terraform-provider-rancher2/issues/1776)) ([cb60c2a](https://github.com/lots0logs/terraform-provider-rancher2/commit/cb60c2a78eaa0b44b1eb2d7d71356ec8b8c5b1d1))
* manual full release workflow ([#1759](https://github.com/lots0logs/terraform-provider-rancher2/issues/1759)) ([73f3e9c](https://github.com/lots0logs/terraform-provider-rancher2/commit/73f3e9c9f4e827310bba58f59dec59f103fe5be4))
* migrate login flow to /v1-public endpoint ([#1997](https://github.com/lots0logs/terraform-provider-rancher2/issues/1997)) ([3523df3](https://github.com/lots0logs/terraform-provider-rancher2/commit/3523df3ed8dceb1db465783a3170be6d1a1e0f33))
* missing quotes causing syntax error ([#1907](https://github.com/lots0logs/terraform-provider-rancher2/issues/1907)) ([6bfbfd4](https://github.com/lots0logs/terraform-provider-rancher2/commit/6bfbfd4fe6faee60c94f87cc9ffe288cc82c2591))
* need to quote json list ([#1875](https://github.com/lots0logs/terraform-provider-rancher2/issues/1875)) ([565c318](https://github.com/lots0logs/terraform-provider-rancher2/commit/565c3182b5e3d23231072a58b2e96afc4fa8d257))
* notifications to issues for manual rc ([#1923](https://github.com/lots0logs/terraform-provider-rancher2/issues/1923)) ([d05989f](https://github.com/lots0logs/terraform-provider-rancher2/commit/d05989fe7c0f4c791173c351768a0c92e185737a))
* prepare for v14 release ([#2012](https://github.com/lots0logs/terraform-provider-rancher2/issues/2012)) ([d396219](https://github.com/lots0logs/terraform-provider-rancher2/commit/d39621997494dbd17f0cd8b38fc8f4d03899d9c8))
* PSACT deletion hanging ([#1653](https://github.com/lots0logs/terraform-provider-rancher2/issues/1653)) ([1bccd68](https://github.com/lots0logs/terraform-provider-rancher2/commit/1bccd68900cd627fbe49545e15086ebe11fc601a))
* rc release calculator for new branches ([#2025](https://github.com/lots0logs/terraform-provider-rancher2/issues/2025)) ([cfad809](https://github.com/lots0logs/terraform-provider-rancher2/commit/cfad809bfda59b7ee8c6e7288b5280cb3550a5bd))
* remove broken resources ([#1693](https://github.com/lots0logs/terraform-provider-rancher2/issues/1693)) ([2785ae4](https://github.com/lots0logs/terraform-provider-rancher2/commit/2785ae4fc73abe826df791f7b02984dc8293ecf0))
* remove GKE enable logic ([#2000](https://github.com/lots0logs/terraform-provider-rancher2/issues/2000)) ([0b9e382](https://github.com/lots0logs/terraform-provider-rancher2/commit/0b9e382e29389c3996a43e346826bb9491f43d36))
* Remove ingress Nginx annotation examples ([#2038](https://github.com/lots0logs/terraform-provider-rancher2/issues/2038)) ([610b2f5](https://github.com/lots0logs/terraform-provider-rancher2/commit/610b2f56d3a6f4bd480e1605e5ff9275bfe18983))
* remove protected filter when getting branches in issue tracking workflow ([#2110](https://github.com/lots0logs/terraform-provider-rancher2/issues/2110)) ([b115402](https://github.com/lots0logs/terraform-provider-rancher2/commit/b1154021d93b9b5450c283859d5c4a8918dd2b26))
* remove pull target ([#2098](https://github.com/lots0logs/terraform-provider-rancher2/issues/2098)) ([3def343](https://github.com/lots0logs/terraform-provider-rancher2/commit/3def343e0c12e269b6fc1df2dcd6bd3acdc04b60))
* remove the default template ([#1780](https://github.com/lots0logs/terraform-provider-rancher2/issues/1780)) ([acc669c](https://github.com/lots0logs/terraform-provider-rancher2/commit/acc669cf0ad10c09d798d197d62aeb33ebc34208))
* repository owner is in github context ([#1891](https://github.com/lots0logs/terraform-provider-rancher2/issues/1891)) ([b23d521](https://github.com/lots0logs/terraform-provider-rancher2/commit/b23d521ee107dfebb9a04823a5d510e6d00a289a))
* run tests in different jobs ([#1859](https://github.com/lots0logs/terraform-provider-rancher2/issues/1859)) ([651634a](https://github.com/lots0logs/terraform-provider-rancher2/commit/651634a862d94779b02e0c2154a62a6cad47782d))
* send linode user data plain text ([8aa0974](https://github.com/lots0logs/terraform-provider-rancher2/commit/8aa0974ce2d51d032052cb3ee598515f17ff2db8))
* set bootstrap sha and release version ([#1755](https://github.com/lots0logs/terraform-provider-rancher2/issues/1755)) ([54b7dcf](https://github.com/lots0logs/terraform-provider-rancher2/commit/54b7dcf3dde80b52a1acaeef5c37b61a1547294b))
* set new release version ([#2021](https://github.com/lots0logs/terraform-provider-rancher2/issues/2021)) ([b466f31](https://github.com/lots0logs/terraform-provider-rancher2/commit/b466f31925f7b6d533e9e1ec8363646029d3df8a))
* short circuit the testing logic ([#1867](https://github.com/lots0logs/terraform-provider-rancher2/issues/1867)) ([42a638d](https://github.com/lots0logs/terraform-provider-rancher2/commit/42a638d5b012d17ff96ccadfb8b52900c034d57f))
* support exceptions in diff suppression ([#1808](https://github.com/lots0logs/terraform-provider-rancher2/issues/1808)) ([2bb8da1](https://github.com/lots0logs/terraform-provider-rancher2/commit/2bb8da1a6bf3fb23ffb6feea549eeda9f4b1506c))
* the first job should never skip ([#1887](https://github.com/lots0logs/terraform-provider-rancher2/issues/1887)) ([d6a3ea6](https://github.com/lots0logs/terraform-provider-rancher2/commit/d6a3ea6de5b7b2200b1a86d4cc4ea9cc51a7ae8a))
* typo in repository context ([#1883](https://github.com/lots0logs/terraform-provider-rancher2/issues/1883)) ([c5ed793](https://github.com/lots0logs/terraform-provider-rancher2/commit/c5ed7931de2049f7b5af8eded61a851d0200a35d))
* typo in script name ([#1915](https://github.com/lots0logs/terraform-provider-rancher2/issues/1915)) ([0257fdf](https://github.com/lots0logs/terraform-provider-rancher2/commit/0257fdf267cba828ace0667569393a6bc0d9336a))
* typo in variable name ([#1911](https://github.com/lots0logs/terraform-provider-rancher2/issues/1911)) ([694d6ee](https://github.com/lots0logs/terraform-provider-rancher2/commit/694d6ee981c52546119d4c6e912932dd95a0c501))
* update checkout ([#1842](https://github.com/lots0logs/terraform-provider-rancher2/issues/1842)) ([58979f1](https://github.com/lots0logs/terraform-provider-rancher2/commit/58979f1c7cd321719497c83ed0a535738070854a))
* Update compatibility matrix ([#1617](https://github.com/lots0logs/terraform-provider-rancher2/issues/1617)) ([1c0e84c](https://github.com/lots0logs/terraform-provider-rancher2/commit/1c0e84c49974f199aa12991afb823368ac33a7a1))
* update machine selector config example ([#1976](https://github.com/lots0logs/terraform-provider-rancher2/issues/1976)) ([bda0250](https://github.com/lots0logs/terraform-provider-rancher2/commit/bda025005fc5ae18427d8a7081db0d235ef5c558))
* update pre-release to see new tag format ([#1623](https://github.com/lots0logs/terraform-provider-rancher2/issues/1623)) ([bbbd78f](https://github.com/lots0logs/terraform-provider-rancher2/commit/bbbd78f9463bd8019904d8bd91cf9899a4297640))
* update rancher2 config map import command ([#1287](https://github.com/lots0logs/terraform-provider-rancher2/issues/1287)) ([1061ac6](https://github.com/lots0logs/terraform-provider-rancher2/commit/1061ac6a404a4dac078a815805e07e04c6fd726a))
* update release config to get proper version ([#1955](https://github.com/lots0logs/terraform-provider-rancher2/issues/1955)) ([c2e8d4a](https://github.com/lots0logs/terraform-provider-rancher2/commit/c2e8d4a5d6559076cb7e01a010377cd3fed14e76))
* update release manifest to force new version ([#1951](https://github.com/lots0logs/terraform-provider-rancher2/issues/1951)) ([c878c36](https://github.com/lots0logs/terraform-provider-rancher2/commit/c878c366a4b2a38dfc06854a5cc7df4a6021aae8))
* update release to 13.1.0 ([#1943](https://github.com/lots0logs/terraform-provider-rancher2/issues/1943)) ([a9ca6e7](https://github.com/lots0logs/terraform-provider-rancher2/commit/a9ca6e7f1fe55dfe8dd9470f1bb91783ba536efc))
* update release to 13.1.1 ([#1947](https://github.com/lots0logs/terraform-provider-rancher2/issues/1947)) ([b4df9f1](https://github.com/lots0logs/terraform-provider-rancher2/commit/b4df9f18173ad061a11bb2a23b2820533573e189))
* update release version ([#1968](https://github.com/lots0logs/terraform-provider-rancher2/issues/1968)) ([687f1a8](https://github.com/lots0logs/terraform-provider-rancher2/commit/687f1a814abac0b5feef7f3b108ed24dd36b6480))
* update versions in registry manifest ([#1963](https://github.com/lots0logs/terraform-provider-rancher2/issues/1963)) ([e75639c](https://github.com/lots0logs/terraform-provider-rancher2/commit/e75639cda6634091849d427105c9642ebbd18cba))
* use back tick instead of single quotes ([#1852](https://github.com/lots0logs/terraform-provider-rancher2/issues/1852)) ([b449a29](https://github.com/lots0logs/terraform-provider-rancher2/commit/b449a2950334b1455c9e4250be01761bca4a2051))
* use environment to pass data to the script ([#1919](https://github.com/lots0logs/terraform-provider-rancher2/issues/1919)) ([0b62b72](https://github.com/lots0logs/terraform-provider-rancher2/commit/0b62b72bde062cccfda622ab132c18415e4f858f))
* use modern import logic ([#1708](https://github.com/lots0logs/terraform-provider-rancher2/issues/1708)) ([1d0d125](https://github.com/lots0logs/terraform-provider-rancher2/commit/1d0d125ca93bd783b1c9cec9245a7e70288bafe9))
* use proper outputs for validating test ([#1871](https://github.com/lots0logs/terraform-provider-rancher2/issues/1871)) ([46c9209](https://github.com/lots0logs/terraform-provider-rancher2/commit/46c920972bc20271b9cfe2ed2cfdb8dc7dd78f44))
* use separate goreleaser files for manual ([#1784](https://github.com/lots0logs/terraform-provider-rancher2/issues/1784)) ([f9cc6bb](https://github.com/lots0logs/terraform-provider-rancher2/commit/f9cc6bb04f3217ccdd4377636f11c80bcb5412b3))
* v3 public fallback logic ([#2081](https://github.com/lots0logs/terraform-provider-rancher2/issues/2081)) ([f9c7a99](https://github.com/lots0logs/terraform-provider-rancher2/commit/f9c7a9910f2adb7cecbec5c3b3268e4ba4e4713a))
